    ...
    <div className="w-full min-h-screen px-4 md:px-12 max-w-[1920px] mx-auto pb-32">
      ...
      <section className="min-h-[85vh] flex flex-col justify-center pt-20 relative">
        <div className="space-y-6 z-10">
          ...
          <div className="flex items-center gap-6 pt-8 waterfall-item">
            ...
            <a href="#" className="p-4 rounded-full bg-[var(--card-bg)] text-[var(--text-primary)] border border-[var(--border-color)] hover:border-blue-500 hover:text-blue-500 transition-all duration-300">
              <Linkedin size={24} />
            </a>
            <a href="#" className="p-4 rounded-full bg-[var(--card-bg)] text-[var(--text-primary)] border border-[var(--border-color)] hover:border-[var(--text-primary)] transition-all duration-300">
              <Mail size={24} />
            </a>
          </div>
        </div>
      ...
      */}
      <div className="mb-12 border-b border-[var(--border-color)] pb-4 flex justify-between items-end">
         ...
         <span className="text-[var(--text-muted)] font-mono text-sm">01 — 04</span>
      </div>
        ...
        {PROJECTS.map((project) => (
          ...
          >
            ...
            <div className="space-y-2">
               ...
               <p className="text-[var(--text-muted)] font-mono text-sm tracking-wide">{project.category}</p>
            </div>
          </article>
        ))}
      </div>
